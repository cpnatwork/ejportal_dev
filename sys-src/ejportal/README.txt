...
ejportal.  You have only created the shell of an AppFuse Java EE
...
2. Create a db user ID="ejuser" with PW="sWa7" and a database 'ejdb' with ejuser having all rights.
  [ default mysql admin user is ID="root" with PW="" (empty) ]

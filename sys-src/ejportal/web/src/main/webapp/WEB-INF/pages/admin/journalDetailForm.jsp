...
<s:form id="journalForm" action="editJournal" method="post" validate="true">
    <s:hidden name="journalBaseTO.id" value="%{journalBaseTO.id}"/>
    ...
    <li id="wwgrp_anmeldedatumFeld" class="wwgrp">    <div         id="wwlbl_anmeldedatumFeld" class="wwlbl">

        <label for="anmeldedatumFeld" class="desc">            Anmeldedatum
            </label>        </div>
        <div id="wwctrl_anmeldedatumFeld" class="wwctrl">
            <input type="text" name="journalBaseTO.anmeldedatum" value="<s:date name="journalBaseTO.anmeldedatum" format="dd.MM.yyyy"/>" id="anmeldedatumFeld" class="text medium"/><SCRIPT LANGUAGE="JavaScript" ID="anmeldeX">
            ...
            <A HREF="#"
               ...
               TITLE="Datum auswaehlen" NAME="anmeldeAnchor" ID="anmeldeAnchor"> <img src="/images/iconCalendar.gif"/> </A>
        </div>
    </li><div id="anmeldeDiv" STYLE="position:absolute;visibility:hidden;background-color:white;layer-background-color:white;"></div>



    <li id="wwgrp_freischaltdatumFeld" class="wwgrp">    <div         id="wwlbl_freischaltdatumFeld" class="wwlbl">
        <label for="freischaltdatumFeld" class="desc">            Freischaltdatum
            </label>        </div>
        <div id="wwctrl_freischaltdatumFeld" class="wwctrl">
            <input type="text" name="journalBaseTO.freischaltdatum" value="<s:date name="journalBaseTO.freischaltdatum" format="dd.MM.yyyy"/>" id="freischaltdatumFeld" class="text medium"/><SCRIPT LANGUAGE="JavaScript" ID="freischaltX">
            ...
            <A HREF="#"
               ...
               TITLE="Datum auswaehlen" NAME="freischaltAnchor" ID="freischaltAnchor"> <img src="/images/iconCalendar.gif"/> </A>
        </div>
    </li><div id="freischaltDiv" STYLE="position:absolute;visibility:hidden;background-color:white;layer-background-color:white;"></div>
    ...
    <li id="wwgrp_bearbeitungsdatumFeld" class="wwgrp">
        ...
        <div id="wwctrl_bearbeitungsdatumFeld" class="wwctrl">
            <input type="text" name="journalBaseTO.bearbeitungsdatum" value="<s:date name="journalBaseTO.bearbeitungsdatum" format="dd.MM.yyyy"/>" id="bearbeitungsdatumFeld"
                   class="text medium"/>
    ...
    <s:select label="Nutzungsbestimmungen" key="journalBaseTO.nutzungsbestimmungen" name="journalBaseTO.nutzungsbestimmungen" value="%{journalBaseTO.nutzungsbestimmungen}" list="listNutzungsbestimmungen"  headerKey="" headerValue="-- Bitte wählen --"/>
    <li id="wwgrp_rotschaltdatumFeld" class="wwgrp">    <div         id="wwlbl_rotschaltdatumFeld" class="wwlbl">
        <label for="rotschaltdatumFeld" class="desc">            Rotschaltungsdatum
            </label>        </div>
        <div id="wwctrl_rotschaltdatumFeld" class="wwctrl">
            <input type="text" name="journalBaseTO.rotschaltungsdatum" value="<s:date name="journalBaseTO.rotschaltungsdatum" format="dd.MM.yyyy"/>" id="rotschaltdatumFeld" class="text medium"/><SCRIPT LANGUAGE="JavaScript" ID="rotschaltX">
            ...
            <A style="text-align:right;" HREF="#"
               ...
               TITLE="Datum auswaehlen" NAME="rotschaltAnchor" ID="rotschaltAnchor"> <img src="/images/iconCalendar.gif"/> </A>
        </div>
    </li><div id="rotschaltDiv" STYLE="position:absolute;visibility:hidden;background-color:white;layer-background-color:white;"></div>


    <s:textfield key="journalBaseTO.rotschaltungsbemerkungen" cssClass="text medium"/>
    <s:select label="Status" key="journalBaseTO.status" name="journalBaseTO.status" value="%{journalBaseTO.status}" list="listStatus"  headerKey="" headerValue="-- Bitte wählen --"/>
    <s:textfield key="journalBaseTO.zdbNummer" cssClass="text medium"/>
    <s:checkbox key="journalBaseTO.readMeTitelbezogen" value="%{journalBaseTO.readMeTitelbezogen}" fieldValue="true" labelposition="left" cssClass="text medium"/>
...
<s:url action="showJournalDetail" var="back">
    <s:param name="journalId" value="%{journalBaseTO.id}"/>
</s:url>
<a href="${back}">zurück zum Journal (ohne Speichern)</a>
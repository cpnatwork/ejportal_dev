...
<h1>Bitte w&auml;hlen Sie für das Interesse einen Besteller aus:</h1>

<s:form id="bestellerSearchForm" action="listProjectBestellerCreate" method="post" validate="true">

...
<s:form id="sigelSearch" action="listProjectBestellerSigelCreate" method="post" validate="true">
    ...
    <s:textfield label="Name des Eigentümers" key="sigelSearchTO.name" required="true" cssClass="text medium"/>
    <s:textfield label="Bibliothek" key="sigelSearchTO.bibliothek" required="true" cssClass="text medium"/>
    <s:textfield label="Fakultät" key="sigelSearchTO.fakultaet" required="true" cssClass="text medium"/>

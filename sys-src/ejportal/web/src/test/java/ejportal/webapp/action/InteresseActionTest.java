...
/**
 * Created by IntelliJ IDEA. User: mkoerner Date: 10.08.2010 Time: 11:46:42 To
...
public class InteresseActionTest extends BaseActionTestCase {
	...
	protected void onSetUpBeforeTransaction() throws Exception {
		...
		this.action = new InteresseAction();
		final InteresseManager interesseManager = (InteresseManager) this.applicationContext
				.getBean("interesseManager");

		this.action.setInteresseManager(interesseManager);
	...
	public void testSave() throws Exception {
		...
		Assert.assertEquals("Updated Interesse", this.action
				.getInteresseBaseTO().getInteresse());
		Assert.assertFalse(this.action.hasActionErrors());
